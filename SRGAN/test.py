...
import torch
from SRGAN.models import SRResNet,Generator
import time
from PIL import Image

# 测试图像
imgPath = './results/pic/629_half.png'
...
if __name__ == '__main__':
    ...
    # 预训练模型
    srgan_checkpoint = "./results/checkpoint_srgan_x2.pth"
    ...
    Bicubic_img.save('./results/pic/629_bicubic.png')
    ...
    with torch.no_grad():
        ...
        sr_img.save('./results/pic/629_srgan_x2.png')
