...
# 数据集参数
# data_folder = '../PANet/BAHNHOF'    # 数据存放路径
data_folder = '..\\ssd.pytorch-master\\ssd.pytorch\\data\\VOCdevkit\\VOC2007\\JPEGImages\\BAHNHOF'
...
srresnet_checkpoint = "./results/checkpoint_srresnet_x2.pth"  # 预训练的SRResNet模型，用来初始化
...
def main():
    ...
    for epoch in range(start_epoch, epochs+1):
        ...
        print('SRGAN/Loss_c', losses_c.val, epoch)
        print('SRGAN/Loss_a', losses_a.val, epoch)
        print('SRGAN/Loss_d', losses_d.val, epoch)
        ...
        }, 'results/checkpoint_srgan_x2.pth')
        t_end = time()
        print("epoch:{}, time:{:.3f}".format(epoch,t_end-t_begin))
